...
$todays_sale=$row6->todaysale;
  ...
  ?>
							...
							<div class="stats-right">
								<label><?php if($todays_sale==''):
								echo "0"; else:
	echo $todays_sale; endif;?></label>
							</div>
							<div class="clearfix"> </div>	
						</div>
						<div class="clearfix"> </div>	
...
$yest_sale=$row7->totalcost;
  ...
  ?>
							...
							<div class="stats-right">
								<label>  <?php if($yest_sale==''):
								echo "0"; else:
	echo $yest_sale; endif;?></label>
							</div>
							<div class="clearfix"> </div>	
						</div>
						<div class="col-md-4 widget states-mdl">
...
$sevendays_sale=$row8->totalcost;
  ...
  ?>
							...
							<div class="stats-right">
								<label><?php if($sevendays_sale==''):
								echo "0"; else:
	echo $sevendays_sale; endif;?></label>
							</div>
							<div class="clearfix"> </div>	
						</div>
						<div class="col-md-4 widget states-last">
...
$total_sale=$row9->totalcost;
  ...
  ?>
							...
							<div class="stats-right">
								<label> <?php if($total_sale==''):
								echo "0"; else:
	echo $total_sale; endif;?></label>
							</div>
							<div class="clearfix"> </div>	
						</div>
						<div class="clearfix"> </div>	
